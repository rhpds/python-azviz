...
def check_resource_groups(subscription_name: str, azviz_command: str) -> Tuple[bool, int, str]:
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            data_lines = [line for line in lines if '│' in line and not ('┏' in line or '┃' in line or '┗' in line or '┯' in line or '┷' in line)]
...
def main():
    ...
    for i, subscription in enumerate(subscriptions, 1):
        ...
        has_resources, rg_count, error = check_resource_groups(sub_name, args.azviz_command)
        ...
        if not has_resources:
            print(f"    📭 No resource groups found - skipping")
